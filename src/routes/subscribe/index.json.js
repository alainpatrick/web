export async function post(event) {
	...
	const mailer_api_url = 'https://api.mailerlite.com/api/v2/groups/109948418/subscribers';
	const options = {
		method: 'POST',
		headers: {
	...
	try {
		...
		console.error('try catch error on fetch - routes/subscribe/index.json.js');
		console.error(error);
